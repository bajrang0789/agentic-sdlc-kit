...
license: Apache-2.0
compatibility: Requires a current Ground Packet and repository map with read access; no network or external mutation is required.
metadata:
  groundtrail-contract: '1'
  groundtrail-id: 'change-charting'
---
