...
license: Apache-2.0
compatibility: Requires supplied Change Thread artifacts and read access; no commands, network, secret access, or external mutation is required.
metadata:
  groundtrail-contract: '1'
  groundtrail-id: 'evidence-handoff'
---
