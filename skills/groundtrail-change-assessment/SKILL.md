...
license: Apache-2.0
compatibility: Requires read access to the change materials and current evidence references; no commands, network, secret access, or external mutation is required.
metadata:
  groundtrail-contract: '1'
  groundtrail-id: 'change-assessment'
---
