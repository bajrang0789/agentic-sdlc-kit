...
license: Apache-2.0
compatibility: Requires a local worktree, current Ground Packet, and allowlisted local checks; no network, secret access, or external mutation is required.
metadata:
  groundtrail-contract: '1'
  groundtrail-id: 'verification-matrix'
---
