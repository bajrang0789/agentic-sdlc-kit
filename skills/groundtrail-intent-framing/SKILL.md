...
license: Apache-2.0
compatibility: Requires a local source repository, a repository map, and read access; no network or external mutation is required.
metadata:
  groundtrail-contract: '1'
  groundtrail-id: 'intent-framing'
---
