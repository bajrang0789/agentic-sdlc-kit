# groundtrail-evidence-handoff

## Outcome

Package current state, evidence references, freshness, and next controls.

## Procedure

Use the primary repository-native skill `groundtrail-evidence-handoff` and retain its current revision binding and evidence rules.
