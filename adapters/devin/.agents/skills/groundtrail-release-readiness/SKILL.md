...
- Carrier capability reductions: `network denial retained as procedure restriction; no verified Skill tool ceiling`, `external mutation retained as procedure restriction; no verified Skill tool ceiling`.
# Release readiness
