...
<!-- Groundtrail carrier: id=incident-learning; version=0.1.0; canonical-digest=cfa063508631a37d0a06438ce60e4fa492da4f1aea68cb14ab100a84f2ec3de6; action-band=recommend; freshness.bindToRevision=true -->

## Carrier contract

- Canonical skill ID: `incident-learning`; canonical SHA-256: `cfa063508631a37d0a06438ce60e4fa492da4f1aea68cb14ab100a84f2ec3de6`.
- Maximum Action Band: `recommend`. Required Control Points: none.
- Required artifacts: `ground-packet`, `source-record-reference`, `trail-record`, `observation-record`. Produced artifacts: `trail-record`, `ground-packet`.
